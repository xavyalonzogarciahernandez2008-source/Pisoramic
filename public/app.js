...
function getUnitLabel(product) {
    ...
    if (qty === 1) {
        const map = { 'unidades':'unidad', 'metros':'metro', 'cajas':'caja', 'bolsas':'bolsa' };
        return map[unit] || (typeof unit === 'string' && unit.endsWith('s') ? unit.slice(0, -1) : unit);
    }
    return unit;
}
...
// Close buttons: close the modal they belong to
        ...
        <div class="product-card">
                ...
                <div class="product-info">
                    <div class="info-item">
                        ...
                        <div class="value quantity ${product.quantity < 10 ? 'low' : ''}">
                            ${product.quantity} ${escapeHtml(getUnitLabel(product))}
                        </div>
                    </div>
                    <div class="info-item">
                        <label>Precio Unitario</label>
                        <div class="value price">Q${parseFloat(product.price).toFixed(2)}</div>
                    </div>
            </div>
            ...
            <div class="product-info">
                    <div class="info-item">
                        ...
                        <div class="value price">Q${(product.quantity * product.price).toFixed(2)}</div>
                    </div>
                <div class="info-item">
                    <label>Creado</label>
...
async function handleAddProduct(e) {
    ...
    formData.append('unit', document.getElementById('unit') ? document.getElementById('unit').value : 'unidades');
...
function editProduct(id) {
    ...
    document.getElementById('editUnit').value = product.unit || 'unidades';
...
async function handleUpdateProduct(e) {
    ...
    formData.append('unit', document.getElementById('editUnit') ? document.getElementById('editUnit').value : 'unidades');
